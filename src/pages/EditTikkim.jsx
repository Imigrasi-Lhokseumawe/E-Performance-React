...
const EditTikkim = () => {
  ...
  const getTikkimById = async () => {
    const response = await axios.get(`http://localhost:5000/tikkim/${id}`);
  ...
  const updateTikkim = async (e) => {
    ...
    try {
      await axios.patch(`http://localhost:5000/tikkim/${id}`, jsonData, {
        headers: {
            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="row g-3" onSubmit={updateTikkim}>
                    <div class="col-md-6">
